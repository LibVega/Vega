...
namespace Vega.Render
{
	...
	public struct VertexPNCT : IEquatable<VertexPNCT>
	{
		/// <summary>
		...
		/// </summary>
		public VertexPNCT(in Vec3 pos, in Vec3 normal, in Color color, in Vec2 uv)
		{
			Position = pos;
			Normal = normal;
			Color = color;
		...
		public readonly override bool Equals(object? obj) =>
			(obj is VertexPNCT vert) && (vert == this);

		readonly bool IEquatable<VertexPNCT>.Equals(VertexPNCT other) =>
			other == this;
		#endregion // Overrides

		#region Operators
		public static bool operator == (in VertexPNCT l, in VertexPNCT r) =>
