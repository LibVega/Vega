...
namespace Vega.Graphics
{
	...
	public enum VertexFormat : int
	{
		...
		// ========================================== MATRIX FORMATS ==================================================
		/// <summary>A floating point matrix with 2 columns and 2 rows.</summary>
		Float2x2 = 1000,
		/// <summary>A floating point matrix with 2 columns and 3 rows.</summary>
		Float2x3 = 1001,
		/// <summary>A floating point matrix with 2 columns and 4 rows.</summary>
		Float2x4 = 1002,
		/// <summary>A floating point matrix with 3 columns and 2 rows.</summary>
		Float3x2 = 1003,
		/// <summary>A floating point matrix with 3 columns and 3 rows.</summary>
		Float3x3 = 1004,
		/// <summary>A floating point matrix with 3 columns and 4 rows.</summary>
		Float3x4 = 1005,
		/// <summary>A floating point matrix with 4 columns and 2 rows.</summary>
		Float4x2 = 1006,
		/// <summary>A floating point matrix with 4 columns and 3 rows.</summary>
		Float4x3 = 1007,
		/// <summary>A floating point matrix with 4 columns and 4 rows.</summary>
		Float4x4 = 1008
	}
}
