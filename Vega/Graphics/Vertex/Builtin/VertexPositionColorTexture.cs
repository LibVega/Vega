...
namespace Vega.Graphics
{
	...
	public struct VertexPositionColorTexture : IEquatable<VertexPositionColorTexture>
	{
		...
		/// </summary>
		public VertexPositionColorTexture(in Vec3 pos, in Color color, in Vec2 uv)
		{
			Position = pos;
			Color = color;
			TexCoord = uv;
		...
		public readonly override bool Equals(object? obj) => 
			(obj is VertexPositionColorTexture vert) && (vert == this);
		...
		#region Operators
		public static bool operator == (in VertexPositionColorTexture l, in VertexPositionColorTexture r) =>
