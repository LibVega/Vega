...
namespace Vega.Graphics
{
	...
	public struct VertexPositionNormalTexture : IEquatable<VertexPositionNormalTexture>
	{
		...
		/// </summary>
		public VertexPositionNormalTexture(in Vec3 pos, in Vec3 normal, in Vec2 uv)
		{
			Position = pos;
			Normal = normal;
			TexCoord = uv;
		...
		public readonly override bool Equals(object? obj) =>
			(obj is VertexPositionNormalTexture vert) && (vert == this);
		...
		#region Operators
		public static bool operator == (in VertexPositionNormalTexture l, in VertexPositionNormalTexture r) =>
