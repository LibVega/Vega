...
namespace Vega
{
	...
	public struct Point3 : IEquatable<Point3>
	{
		...
		/// <param name="z">The z-coordinate value.</param>
		public Point3(in Point2 p, int z)
		{
			X = p.X;
			Y = p.Y;
			Z = z;
		...
		#region Overrides
		public readonly override bool Equals(object? obj) => (obj is Point3 p) && (p == this);

		public readonly override int GetHashCode() => HashCode.Combine(X, Y, Z);

		public readonly override string ToString() => $"{{{X} {Y} {Z}}}";

		readonly bool IEquatable<Point3>.Equals(Point3 other) => other == this;
		#endregion // Overrides
