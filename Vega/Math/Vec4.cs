...
{
	/// <summary>
	/// Describes a 4-component position in cartesian space.
	/// </summary>
	...
	public struct Vec4 : IEquatable<Vec4>
	{
		...
		public readonly override bool Equals(object? obj) => (obj is Vec4 vec) && (vec == this);
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static bool NearlyEqual(in Vec4 l, in Vec4 r, float eps = MathHelper.FLOAT_EPSILON) =>
			MathHelper.NearlyEqualFast(l.X, r.X, eps) && MathHelper.NearlyEqualFast(l.Y, r.Y, eps) &&
			MathHelper.NearlyEqualFast(l.Z, r.Z, eps) && MathHelper.NearlyEqualFast(l.W, r.W, eps);
